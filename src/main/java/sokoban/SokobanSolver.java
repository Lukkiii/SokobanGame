...
public class SokobanSolver {
    ...
    public static void main(String[] args) {
        try {
            ...
            generatePDDL(grid, "src/main/java/sokoban/sokoban-problem.pddl");

            // Solve the PDDL problem
            Plan solution = solveWithPDDL4J("src/main/java/sokoban/sokoban.pddl", "src/main/java/sokoban/sokoban-problem.pddl");
